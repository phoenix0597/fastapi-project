...
### Приложение при разворачивании на VPS-сервере имеет следующие интерфейсы доступа:
...
- **Web интерфейс**: http://<HOST_IP>:9000/pages/hotels?location=%D0%90%D0%BB%D1%82%D0%B0%D0%B9&date_from=2025-08-29&date_to=2025-09-12
    ...
    Здесь же можно сымитировавть нагрузку на сервер, нажимая на соответствующие кнопки (включая генерацию ошибки `ZeroDivisionError`) и, перейдя в `Grafana`, просмотреть графики мониторинга.
